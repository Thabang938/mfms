...
export default function SideBar() {
  ...
  return (
    <aside
      className={`bg-green-800 text-white h-screen transition-all duration-300 ${
        expanded ? 'w-64' : 'w-20'
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-4 bg-white text-green-800 rounded-full p-2 shadow-md hover:bg-green-100 transition"
      >
